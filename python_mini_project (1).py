...
def view_cart(order,menu):
    if order is None:
        ...
        print(green(f"The total cost is Rs {total_cost}/-",['italic']))
...
# Exit
def exit_program():
    print("____________________*Thank you for using our food ordering system! Please visit again!*____________________",['bold','italic'])
    exit()
...
def account_login_or_create():
    ...
    while True:
        ...
        print(red("__________________________________________________________________",['bold']))
        print(" ")
...
def main():
    ...
    while True:
            ...
            print(" ")
            print('\033[1;3m'+"1. Browse the menu"+'\033[1;3m')
            print('\033[1;3m'+"2. View my cart"+'\033[1;3m')
            print('\033[1;3m'+"3. Checkout"+'\033[1;3m')
            print('\033[1;3m'+"4. Quit"+'\033[1;3m')
